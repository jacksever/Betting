...
{
    [DbContext(typeof(BeetingContext))]
    [Migration("20201031151759_init")]
    partial class init
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Betting.Data.Models.PlayerStatistic", b =>
                {
                    ...
                    b.Property<string>("Assits")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("MinutesPlayed")
                        .HasColumnType("int");

                    b.Property<string>("ScoredGoals")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Betting.Data.Models.Game", b =>
                {
                    ...
                    b.HasOne("Betting.Data.Models.Player", null)
                        .WithMany("Games")
            ...
            modelBuilder.Entity("Betting.Data.Models.Player", b =>
                {
                    b.HasOne("Betting.Data.Models.Game", null)
                        .WithMany("Players")
                        .HasForeignKey("GameId");
